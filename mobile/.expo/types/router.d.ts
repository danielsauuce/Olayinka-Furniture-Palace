  ...
  export namespace ExpoRouter {
    export interface __routes<T extends string | object = string> {
      hrefInputParams:
        ...
        | { pathname: `${'/(tabs)'}/shop` | `/shop`; params?: Router.UnknownInputParams }
        | { pathname: `${'/(tabs)'}/support` | `/support`; params?: Router.UnknownInputParams };
      hrefOutputParams:
        ...
        | { pathname: `${'/(tabs)'}/cart` | `/cart`; params?: Router.UnknownOutputParams }
        | { pathname: `${'/(tabs)'}` | `/`; params?: Router.UnknownOutputParams }
        | { pathname: `${'/(tabs)'}/profile` | `/profile`; params?: Router.UnknownOutputParams }
        | { pathname: `${'/(tabs)'}/shop` | `/shop`; params?: Router.UnknownOutputParams }
        | { pathname: `${'/(tabs)'}/support` | `/support`; params?: Router.UnknownOutputParams };
      href:
        | Router.RelativePathString
        | Router.ExternalPathString
        | `/${`?${string}` | `#${string}` | ''}`
        | `/_sitemap${`?${string}` | `#${string}` | ''}`
        | `${'/(tabs)'}/cart${`?${string}` | `#${string}` | ''}`
        | `/cart${`?${string}` | `#${string}` | ''}`
        | `${'/(tabs)'}${`?${string}` | `#${string}` | ''}`
        | `/${`?${string}` | `#${string}` | ''}`
